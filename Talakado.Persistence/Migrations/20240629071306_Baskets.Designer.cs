...
namespace Talakado.Persistence.Migrations
{
    ...
    [Migration("20240629071306_Baskets")]
            ...
            modelBuilder.Entity("Talakado.Domain.Basket.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 525, DateTimeKind.Local).AddTicks(5654));
            ...
            modelBuilder.Entity("Talakado.Domain.Basket.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 526, DateTimeKind.Local).AddTicks(646));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 526, DateTimeKind.Local).AddTicks(6532));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 527, DateTimeKind.Local).AddTicks(2591));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 528, DateTimeKind.Local).AddTicks(53));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 528, DateTimeKind.Local).AddTicks(4626));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 10, 43, 2, 528, DateTimeKind.Local).AddTicks(9483));
