...
namespace Talakado.Persistence.Migrations
{
    ...
    [Migration("20240402061508_catalog_item")]
    partial class catalog_item
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 2, 9, 45, 1, 429, DateTimeKind.Local).AddTicks(9773));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 9, 45, 1, 430, DateTimeKind.Local).AddTicks(9101));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 9, 45, 1, 432, DateTimeKind.Local).AddTicks(862));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 9, 45, 1, 432, DateTimeKind.Local).AddTicks(9962));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 2, 9, 45, 1, 434, DateTimeKind.Local).AddTicks(383));
