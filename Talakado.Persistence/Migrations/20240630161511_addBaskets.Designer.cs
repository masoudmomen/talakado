...
namespace Talakado.Persistence.Migrations
{
    ...
    [Migration("20240630161511_addBaskets")]
            ...
            modelBuilder.Entity("Talakado.Domain.Basket.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 384, DateTimeKind.Local).AddTicks(326));
            ...
            modelBuilder.Entity("Talakado.Domain.Basket.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 384, DateTimeKind.Local).AddTicks(2952));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 384, DateTimeKind.Local).AddTicks(5837));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 384, DateTimeKind.Local).AddTicks(8616));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 385, DateTimeKind.Local).AddTicks(2259));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 385, DateTimeKind.Local).AddTicks(4597));
            ...
            modelBuilder.Entity("Talakado.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 19, 45, 10, 385, DateTimeKind.Local).AddTicks(7278));
