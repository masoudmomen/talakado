...
namespace Talakado.Persistence.Seeds
{
    public class DataBaseContextSeed
    {
        ...
        private static IEnumerable<CatalogType> GetCatalogTypes()
        {
            return new List<CatalogType>()
            {
                ...
                new CatalogType{Id=4,Type="پاوربانک",ParentCatalogTypeId=2},
                new CatalogType{Id=5,Type="کاور گوشی",ParentCatalogTypeId=2}
            };
        }
        private static IEnumerable<CatalogBrand> GetCatalogBrands()
        {
            return new List<CatalogBrand>()
            {
                ...
                new CatalogBrand{Id=4,Brand="ال جی"},
                new CatalogBrand{Id=5,Brand="لنوو"}
            };
        }
    }
}
